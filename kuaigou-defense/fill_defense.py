...
class KuaigouDefenseFiller:
    ...
    def fill_all(self, plaintiff, defendant, case_number, shop_name,
        ...
        # 1. 授权委托书
        auth_template = self.templates_dir / "1-快购-授权委托书.docx"
        ...
        # 2. 任职证明
        emp_template = self.templates_dir / "2-快购-任职证明.docx"
...
def main():
    parser = argparse.ArgumentParser(description="快购答辩文档自动填写工具")
    ...
    filler = KuaigouDefenseFiller(output_dir=args.output_dir)
